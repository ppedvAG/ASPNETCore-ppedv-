...
namespace GrpcService.Protos {
    ...
    static CustomersReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "dCIlChNDdXN0b21lckxvb2t1cE1vZGVsEg4KBnVzZXJJZBgBIAEoBSJmCg1D",
            "dXN0b21lck1vZGVsEhEKCWZpcnN0TmFtZRgBIAEoCRIQCghsYXN0TmFtZRgC",
            "IAEoCRISCgplbWFpQWRyZXNzGAMgASgJEg8KB2lzQWxpdmUYBCABKAgSCwoD",
            "YWdlGAUgASgFMn0KCEN1c3RvbWVyEjcKD0dldEN1c3RvbWVySW5mbxIULkN1",
            "c3RvbWVyTG9va3VwTW9kZWwaDi5DdXN0b21lck1vZGVsEjgKD0dldE5ld0N1",
            "c3RvbWVycxITLk5ld0N1c3RvbWVyUmVxdWVzdBoOLkN1c3RvbWVyTW9kZWww",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::GrpcService.Protos.CustomerModel), global::GrpcService.Protos.CustomerModel.Parser, new[]{ "FirstName", "LastName", "EmaiAdress", "IsAlive", "Age" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class CustomerModel : pb::IMessage<CustomerModel> {
    ...
    /// <summary>Field number for the "emaiAdress" field.</summary>
    public const int EmaiAdressFieldNumber = 3;
    private string emaiAdress_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public string EmaiAdress {
      get { return emaiAdress_; }
      set {
        emaiAdress_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(CustomerModel other) {
      ...
      if (EmaiAdress != other.EmaiAdress) return false;
    ...
    public override int GetHashCode() {
      ...
      if (EmaiAdress.Length != 0) hash ^= EmaiAdress.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (EmaiAdress.Length != 0) {
        output.WriteRawTag(26);
        output.WriteString(EmaiAdress);
      }
      if (IsAlive != false) {
    ...
    public int CalculateSize() {
      ...
      if (EmaiAdress.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(EmaiAdress);
      }
      if (IsAlive != false) {
        size += 1 + 1;
      }
    ...
    public void MergeFrom(CustomerModel other) {
      ...
      if (other.EmaiAdress.Length != 0) {
        EmaiAdress = other.EmaiAdress;
      }
